"""
Train the weekly horizon.

Thin wrapper. All logic lives in train_core. This script trains the three weekly quantile
boosters (Q10, Q50, Q90) on the weekly train split and saves them as development models.
"""
