"""
Train the monthly horizon.

Thin wrapper. All logic lives in train_core. This script trains the three monthly quantile
boosters (Q10, Q50, Q90) on the monthly train split and saves them as development models.
"""
